...
class FireGento_AlternativeContentStorage_Model_Storage_Git extends FireGento_AlternativeContentStorage_Model_Storage_File
{

    const DIRECTORY_CONFIG_PATH = 'acs/storage_git/directory';
