...
class FireGento_ContentSync_Block_Notice extends Mage_Adminhtml_Block_Abstract
{
    ...
    {
        return FireGento_ContentSync_Model_Notice::getManuelUpdateNoticeType();
    }
    ...
    {
        return FireGento_ContentSync_Model_Notice::getManuelUpdateNoticeTypeLabel($type);
    }
    ...
    {
        return FireGento_ContentSync_Model_Notice::getManuelUpdateNoticeTypeUrl($type);
    }
